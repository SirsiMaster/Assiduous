...
### Fixed
- fix(agent-leads): align with firebase-ready and disable compat persistence
...
### Added
- feat(deals): document deal graph and finalize ingest workflows
...
### Added
- feat(opensign): add envelopes listing endpoint and status ui
...
### Added
- feat(auth): gate lob letters to admin and agent roles


## [0.134.0] - 2025-12-05

### Added
- feat(lob): add certified mail sender UI


## [0.133.0] - 2025-12-05

### Added
- feat(lob): add certified mail letters endpoint


## [0.132.0] - 2025-12-05

### Added
- feat(plaid): add banking link, token exchange and accounts endpoints
...
### Added
- feat(profile-qr): Add profile settings UIs and QR backfill
...
### Fixed
- fix(qr): Add Firebase SDK to property detail pages for QR widget functionality
...
### Added
- feat: Add Firestore security rules for clients collection


## [0.116.5] - 2025-11-11

### Fixed
- fix: Add try-catch to auth initialization retry logic
...
### Fixed
- fix: Remove standalone login pages, enforce index.html modal only


## [0.116.0] - 2025-11-10

### Added
- feat(portals): build complete functional pages for all sidebar links
...
### Fixed
- fix(portals): completely rebuild all broken pages with correct UCS structure


## [0.114.5] - 2025-11-10

### Fixed
- fix(portals): replace template vars and remove duplicate CSS in all pages
...
### Added
- feat(navigation): add specifications link to development section
...
[0.132.0]: https://github.com/SirsiMaster/Assiduous/compare/v0.131.0...v0.132.0
