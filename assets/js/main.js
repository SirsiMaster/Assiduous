...
const i18nData = {
    en: {
        ...
        'hero.subtitle': 'Discover your perfect property with our advanced AI matching system. Get instant market analysis, automated property alerts, and personalized recommendations.',
        ...
        'features.aiMatching.desc': 'Our smart algorithm learns your preferences and automatically suggests properties that match your criteria.',
        'features.marketAnalysis.title': 'Instant Market Analysis',
        'features.marketAnalysis.desc': 'Get real-time property valuations, market trends, and investment potential analysis powered by AI.',
        'features.smartAlerts.title': 'Smart Alerts',
        'features.smartAlerts.desc': 'Never miss a deal with our AI-powered alert system that monitors the market 24/7 for your perfect match.',
        'features.aiAssistant.title': '24/7 AI Assistant',
        'features.aiAssistant.desc': 'Get instant answers to your real estate questions with our intelligent chatbot available around the clock.',
        'features.mobile.title': 'Mobile Experience',
        'features.mobile.desc': 'Access all features on the go with our responsive design and mobile-optimized interface.',
        'features.leadGen.title': 'Lead Generation',
        'features.leadGen.desc': 'Automated lead capture and nurturing system that converts visitors into clients efficiently.',
        ...
        // Footer
        'footer.copyright': '© 2025 Assiduous Real Estate AI System. Professional implementation by elite developers.'
    },
    es: {
        // Navigation
        'nav.home': 'Inicio',
        ...
        'hero.subtitle': 'Descubre tu propiedad perfecta con nuestro sistema avanzado de emparejamiento con IA. Obtén análisis instantáneos del mercado, alertas automáticas de propiedades y recomendaciones personalizadas.',
        ...
        'features.aiMatching.desc': 'Nuestro algoritmo inteligente aprende tus preferencias y sugiere automáticamente propiedades que coinciden con tus criterios.',
        'features.marketAnalysis.title': 'Análisis Instantáneo del Mercado',
        'features.marketAnalysis.desc': 'Obtén valuaciones inmobiliarias en tiempo real, tendencias del mercado y análisis de potencial de inversión impulsado por IA.',
        'features.smartAlerts.title': 'Alertas Inteligentes',
        'features.smartAlerts.desc': 'Nunca pierdas una oportunidad con nuestro sistema de alertas impulsado por IA que monitorea el mercado 24/7 para tu emparejamiento perfecto.',
        'features.aiAssistant.title': 'Asistente IA 24/7',
        'features.aiAssistant.desc': 'Obtén respuestas instantáneas a tus preguntas inmobiliarias con nuestro chatbot inteligente disponible las 24 horas.',
        'features.mobile.title': 'Experiencia Móvil',
        'features.mobile.desc': 'Accede a todas las funciones sobre la marcha con nuestro diseño responsivo e interfaz optimizada para móviles.',
        'features.leadGen.title': 'Generación de Leads',
        'features.leadGen.desc': 'Sistema automatizado de captura y nutrición de leads que convierte visitantes en clientes de manera eficiente.',
        ...
        // Footer
        'footer.copyright': '© 2025 Sistema IA de Bienes Raíces Assiduous. Implementación profesional por desarrolladores élite.'
    }
};
...
function showSection(sectionId) {
    ...
    const allSections = document.querySelectorAll('.content-section, .hero-section, .features-section');
...
function setupAlerts() {
    ...
    // Show confirmation
    showNotification('AI property alerts activated! You\'ll receive notifications for matching properties.', 'success');
}
...
function generateAIResponse(userMessage) {
    const responses = {
        ...
        'price': 'Property prices vary by location. I can provide a detailed market analysis for any area.',
        'valuation': 'I can provide instant AI-powered property valuations. Just give me the address and property details.',
        'investment': 'Looking for investment opportunities? I can analyze ROI potential and market trends.',
        ...
        'default': 'I understand you\'re asking about real estate. Could you be more specific? I can help with property search, valuations, market analysis, or investment advice.'
    };
...
function generateAIResponse(userMessage) {
    ...
    const responses = {
        ...
        es: {
            ...
            'propiedades': '¡Puedo ayudarte a encontrar propiedades! ¿Cuál es tu presupuesto y ubicación preferida?',
            'precio': 'Los precios de propiedades varían según la ubicación. Puedo proporcionar un análisis detallado del mercado para cualquier área.',
            'valuacion': 'Puedo proporcionar valuaciones instantáneas de propiedades con IA. Solo dame la dirección y detalles de la propiedad.',
            'inversion': '¿Buscas oportunidades de inversión? Puedo analizar el potencial de ROI y tendencias del mercado.',
            'mercado': 'El mercado actual muestra fundamentos sólidos con niveles de inventario equilibrados.',
            'comprar': '¿Listo para comprar? Puedo ayudarte a emparejar con propiedades que se ajusten perfectamente a tus criterios.',
            'vender': '¿Pensando en vender? Puedo proporcionar un análisis completo del mercado y estrategia de precios.',
            'default': 'Entiendo que estás preguntando sobre bienes raíces. ¿Podrías ser más específico? Puedo ayudar con búsqueda de propiedades, valuaciones, análisis de mercado o asesoramiento de inversión.'
        }
    };
